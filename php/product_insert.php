...
<?php
	...
	$sql = "insert into product (animal, category, name, price, introduce, information, regist_day, hit,  file_name, file_type, file_copied) ";
	$sql .= "values('$animal', '$category', '$name', '$price', '$introduce', '$information', '$regist_day', 0, ";
