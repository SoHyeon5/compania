        ...
        <section>
            <div id="admin_box">
                <div id="admin-member">
                    <div id="admin-title">
                        <h3>관리자 모드 > 회원 관리</h3>
                        <button class="admin-open1"></button>
                        <button class="admin-close1"></button>
                    </div>
                ...
                <div id="admin-product">
                    <div id="admin-title">
                        <h3>관리자 모드 > 상품 관리</h3>
                        <button class="admin-open2"></button>
                        <button class="admin-close2"></button>
                    </div>
                    ...
                    <div id="adminbox2">
                            ...
                            <form method="post" action="admin_product_delete.php">
                                <ul id="board_list"> 
                                    ...
                                    <div>
                                        ...
                                        <li>
                                            <span class="ckdel"><input type="checkbox" name="item[]" value="<?=$num?>"></span>
                                        </li>
                                    </div>
                            ...
                            <form method="post" action="product_form.php">
                                <div class="buttons2">    
                                            ...
                                            ?>
                                                <a href="javascript:alert('로그인 후 이용해 주세요!')"><button class="pro-upload">상품 등록 바로가기</button></a>                
                                            <?php
                                            }
                                            ?>
                ...
                <div id="admin-one">
                    <div id="admin-title">
                        ...
                        <button class="admin-open3"></button>
                        <button class="admin-close3"></button>
                    </div>
                    ...
                    <div id="adminbox3">
                        <form method="post" action="admin_QnAone_delete.php">
                            <ul id="qa_list1">
                                ...
                                <ul id="qa_list2">
                                    <li>
                                        <p class="qa1"><?=$number?></p>
                                        <p class="qa2"><?=$id?></p>
                                        <p class="qa3"><a href="admin_QnAone_view.php?num=<?=$num?>&page=<?=$page?>"><?=$title?></a></p>
                                        <p class="qa4"><?=$regist_day?></p>
                                        <p class="qa5"><input type="checkbox" name="qnaone[]" value="<?=$num?>"></p> 
                                    </li>
                                </ul>
                            <?php
                                $number--;
                ...
                <div id="admin-qna">
                    <div id="admin-title">
                        <h3>관리자 모드 > 자주 묻는 질문 관리</h3>
                        <button class="admin-open4"></button>
                        <button class="admin-close4"></button>
                    </div>
                            ...
                            <ul id="qa_list1">
                                ...
                                <ul id="qa_list2">
                                    <li>
                                        <p class="qa1"><?=$num?></p>
                                        <p class="qa2"><?=$name?></p>
                                        <p class="qa3"><?=$subject?></p>
                                        <p class="qa4"><?=$regist_day?></p>
                                        <p class="qa5"><input type="checkbox" name="qna[]" value="<?=$num?>"></p> 
                                    </li>
                                </ul>
                            <?php
                                $number--;
